...
var Month = factory((_props, ref) => {
  ...
  const rows = dates.map((row, rowIndex) => {
    const cells = row.map((date, cellIndex) => {
      ...
      const ariaLabel = (getDayAriaLabel == null ? void 0 : getDayAriaLabel(date)) || (0, import_dayjs11.default)(date).locale(locale || ctx.locale).format("D MMMM YYYY");
      const dayProps = getDayProps == null ? void 0 : getDayProps(date);
      const isDateInTabOrder = (0, import_dayjs11.default)(date).isSame(dateInTabOrder, "date");
...
function isYearDisabled(year, minDate, maxDate) {
  ...
  if (minDate && (0, import_dayjs12.default)(year).isBefore(minDate, "year")) {
    return true;
  }
  if (maxDate && (0, import_dayjs12.default)(year).isAfter(maxDate, "year")) {
    return true;
  }
  return false;
}
...
function getYearInTabOrder(years, minDate, maxDate, getYearControlProps) {
  ...
  const currentYear = enabledYears.find((year) => (0, import_dayjs13.default)().isSame(year, "year"));
  if (currentYear) {
    return currentYear;
  }
...
var YearsList = factory((_props, ref) => {
  ...
  const rows = years.map((yearsRow, rowIndex) => {
    const cells = yearsRow.map((year, cellIndex) => {
      ...
      const isYearInTabOrder = (0, import_dayjs14.default)(year).isSame(yearInTabOrder, "year");
      return import_react9.default.createElement(
        ...
        import_react9.default.createElement(
          ...
          (0, import_dayjs14.default)(year).locale(ctx.getLocale(locale)).format(yearsListFormat)
        )
      );
    });
...
function isMonthDisabled(month, minDate, maxDate) {
  ...
  if (minDate && (0, import_dayjs15.default)(month).isBefore(minDate, "month")) {
    return true;
  }
  if (maxDate && (0, import_dayjs15.default)(month).isAfter(maxDate, "month")) {
    return true;
  }
  return false;
}
...
function getMonthInTabOrder(months, minDate, maxDate, getMonthControlProps) {
  ...
  const currentMonth = enabledMonths.find((month) => (0, import_dayjs16.default)().isSame(month, "month"));
  if (currentMonth) {
    return currentMonth;
  }
...
function getMonthsData(year) {
  const startOfYear = (0, import_dayjs17.default)(year).startOf("year").toDate();
  const results = [[], [], [], []];
  let currentMonthIndex = 0;
  for (let i = 0; i < 4; i += 1) {
    for (let j = 0; j < 3; j += 1) {
      results[i].push((0, import_dayjs17.default)(startOfYear).add(currentMonthIndex, "months").toDate());
      currentMonthIndex += 1;
    }
  }
  return results;
...
var MonthsList = factory((_props, ref) => {
  ...
  const rows = months.map((monthsRow, rowIndex) => {
    const cells = monthsRow.map((month, cellIndex) => {
      ...
      const isMonthInTabOrder = (0, import_dayjs18.default)(month).isSame(monthInTabOrder, "month");
      return import_react10.default.createElement(
        ...
        import_react10.default.createElement(
          ...
          (0, import_dayjs18.default)(month).locale(ctx.getLocale(locale)).format(monthsListFormat)
        )
      );
    });
...
var DecadeLevel = factory((_props, ref) => {
  ...
  const _nextDisabled = typeof nextDisabled === "boolean" ? nextDisabled : maxDate ? !(0, import_dayjs19.default)(endOfDecade).endOf("year").isBefore(maxDate) : false;
  const _previousDisabled = typeof previousDisabled === "boolean" ? previousDisabled : minDate ? !(0, import_dayjs19.default)(startOfDecade).startOf("year").isAfter(minDate) : false;
  const formatDecade = (date, format) => (0, import_dayjs19.default)(date).locale(locale || ctx.locale).format(format);
...
var YearLevel = factory((_props, ref) => {
  ...
  const _nextDisabled = typeof nextDisabled === "boolean" ? nextDisabled : maxDate ? !(0, import_dayjs20.default)(year).endOf("year").isBefore(maxDate) : false;
  const _previousDisabled = typeof previousDisabled === "boolean" ? previousDisabled : minDate ? !(0, import_dayjs20.default)(year).startOf("year").isAfter(minDate) : false;
  return import_react13.default.createElement(Box, { "data-year-level": true, size, ref, ...others }, import_react13.default.createElement(
    CalendarHeader,
    {
      label: typeof yearLabelFormat === "function" ? yearLabelFormat(year) : (0, import_dayjs20.default)(year).locale(locale || ctx.locale).format(yearLabelFormat),
      __preventFocus,
      __stopPropagation,
      nextIcon,
      previousIcon,
...
var MonthLevel = factory((_props, ref) => {
  ...
  const _nextDisabled = typeof nextDisabled === "boolean" ? nextDisabled : maxDate ? !(0, import_dayjs21.default)(month).endOf("month").isBefore(maxDate) : false;
  const _previousDisabled = typeof previousDisabled === "boolean" ? previousDisabled : minDate ? !(0, import_dayjs21.default)(month).startOf("month").isAfter(minDate) : false;
  return import_react14.default.createElement(Box, { "data-month-level": true, size, ref, ...others }, import_react14.default.createElement(
    CalendarHeader,
    {
      label: typeof monthLabelFormat === "function" ? monthLabelFormat(month) : (0, import_dayjs21.default)(month).locale(locale || ctx.locale).format(monthLabelFormat),
      __preventFocus,
      __stopPropagation,
      nextIcon,
      previousIcon,
...
var DecadeLevelGroup = factory((_props, ref) => {
  ...
  const decades = Array(numberOfColumns).fill(0).map((_, decadeIndex) => {
    const currentDecade = (0, import_dayjs22.default)(decade).add(decadeIndex * 10, "years").toDate();
...
var YearLevelGroup = factory((_props, ref) => {
  ...
  const years = Array(numberOfColumns).fill(0).map((_, yearIndex) => {
    const currentYear = (0, import_dayjs23.default)(year).add(yearIndex, "years").toDate();
...
var MonthLevelGroup = factory((_props, ref) => {
  ...
  const months = Array(numberOfColumns).fill(0).map((_, monthIndex) => {
    const currentMonth = (0, import_dayjs24.default)(month).add(monthIndex, "months").toDate();
...
var Calendar = factory((_props, ref) => {
  ...
  const handleNextMonth = () => {
    const nextDate = (0, import_dayjs26.default)(currentDate).add(_columnsToScroll, "month").toDate();
    onNextMonth == null ? void 0 : onNextMonth(nextDate);
    setDate(nextDate);
  };
  const handlePreviousMonth = () => {
    const nextDate = (0, import_dayjs26.default)(currentDate).subtract(_columnsToScroll, "month").toDate();
    onPreviousMonth == null ? void 0 : onPreviousMonth(nextDate);
    setDate(nextDate);
  };
  const handleNextYear = () => {
    const nextDate = (0, import_dayjs26.default)(currentDate).add(_columnsToScroll, "year").toDate();
    onNextYear == null ? void 0 : onNextYear(nextDate);
    setDate(nextDate);
  };
  const handlePreviousYear = () => {
    const nextDate = (0, import_dayjs26.default)(currentDate).subtract(_columnsToScroll, "year").toDate();
    onPreviousYear == null ? void 0 : onPreviousYear(nextDate);
    setDate(nextDate);
  };
  const handleNextDecade = () => {
    const nextDate = (0, import_dayjs26.default)(currentDate).add(10 * _columnsToScroll, "year").toDate();
    onNextDecade == null ? void 0 : onNextDecade(nextDate);
    setDate(nextDate);
  };
  const handlePreviousDecade = () => {
    const nextDate = (0, import_dayjs26.default)(currentDate).subtract(10 * _columnsToScroll, "year").toDate();
...
function isInRange(date, range) {
  ...
  return (0, import_dayjs27.default)(_range[0]).startOf("day").subtract(1, "ms").isBefore(date) && (0, import_dayjs27.default)(_range[1]).endOf("day").add(1, "ms").isAfter(date);
}
...
function useDatesState({
  ...
  const onDateChange = (date) => {
    if (type === "range") {
      if (pickedDate instanceof Date && !_value[1]) {
        if ((0, import_dayjs28.default)(date).isSame(pickedDate, level) && !allowSingleDateInRange) {
          setPickedDate(null);
          setHoveredDate(null);
          setValue([null, null]);
          return;
      ...
      if (_value[0] && !_value[1] && (0, import_dayjs28.default)(date).isSame(_value[0], level) && !allowSingleDateInRange) {
        setPickedDate(null);
        setHoveredDate(null);
        setValue([null, null]);
        return;
    ...
    if (type === "multiple") {
      if (_value.some((selected) => (0, import_dayjs28.default)(selected).isSame(date, level))) {
        setValue(_value.filter((selected) => !(0, import_dayjs28.default)(selected).isSame(date, level)));
      } else {
        setValue([..._value, date]);
      }
      return;
    }
    if (_value && allowDeselect && (0, import_dayjs28.default)(date).isSame(_value, level)) {
      setValue(null);
    } else {
      setValue(date);
    }
  ...
  const isFirstInRange = (date) => {
    ...
    if ((0, import_dayjs28.default)(date).isSame(_value[0], level)) {
      return !(hoveredDate && (0, import_dayjs28.default)(hoveredDate).isBefore(_value[0]));
    }
    return false;
  };
  const isLastInRange = (date) => {
    if (_value[1] instanceof Date) {
      return (0, import_dayjs28.default)(date).isSame(_value[1], level);
    }
    if (!(_value[0] instanceof Date) || !hoveredDate) {
      return false;
    }
    return (0, import_dayjs28.default)(hoveredDate).isBefore(_value[0]) && (0, import_dayjs28.default)(date).isSame(_value[0], level);
  };
  const getControlProps = (date) => {
    if (type === "range") {
      return {
        selected: _value.some(
          (selection) => selection && (0, import_dayjs28.default)(selection).isSame(date, level)
        ),
        inRange: isDateInRange(date),
        firstInRange: isFirstInRange(date),
        lastInRange: isLastInRange(date),
        "data-autofocus": !!_value[0] && (0, import_dayjs28.default)(_value[0]).isSame(date, level) || void 0
      };
    }
    if (type === "multiple") {
      return {
    ...
    const selected = (0, import_dayjs28.default)(_value).isSame(date, level);
...
function isDateValid({ date, maxDate, minDate }) {
  ...
  if (maxDate && (0, import_dayjs33.default)(date).isAfter(maxDate, "date")) {
    return false;
  }
  if (minDate && (0, import_dayjs33.default)(date).isBefore(minDate, "date")) {
    return false;
  }
  return true;
}
...
var DateInput = factory((_props, ref) => {
  ...
  const defaultDateParser = (val) => {
    const parsedDate = (0, import_dayjs34.default)(val, valueFormat, ctx.getLocale(locale)).toDate();
  ...
  const formatValue2 = (val) => val ? (0, import_dayjs34.default)(val).locale(ctx.getLocale(locale)).format(valueFormat) : "";
  ...
  const _getDayProps = (day) => ({
    ...
    selected: (0, import_dayjs34.default)(_value).isSame(day, "day"),
    onClick: () => {
      const valueWithTime = preserveTime ? assignTime(_value, day) : day;
      const val = clearable && _allowDeselect ? (0, import_dayjs34.default)(_value).isSame(day, "day") ? null : valueWithTime : valueWithTime;
      setValue(val);
...
var DateTimePicker = factory((_props, ref) => {
  ...
  const formatTime = (dateValue) => dateValue ? (0, import_dayjs35.default)(dateValue).format(withSeconds ? "HH:mm:ss" : "HH:mm") : "";
  ...
  const formattedValue = _value ? (0, import_dayjs35.default)(_value).locale(ctx.getLocale(locale)).format(_valueFormat) : "";
