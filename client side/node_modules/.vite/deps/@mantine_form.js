...
function useForm({
  ...
  const setFieldValue = (0, import_react2.useCallback)((path, value) => {
    ...
    _setValues((current) => {
      ...
      onValuesChange == null ? void 0 : onValuesChange(result, current);
      return result;
    });
  ...
  const setValues = (0, import_react2.useCallback)((payload) => {
    _setValues((currentValues) => {
      ...
      onValuesChange == null ? void 0 : onValuesChange(result, currentValues);
      return result;
    });
...
var Form = (0, import_react4.forwardRef)(
  ({ form, onSubmit, onReset, ...others }, ref) => import_react4.default.createElement(
    "form",
    {
      ...others,
