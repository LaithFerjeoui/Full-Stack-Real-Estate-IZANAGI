...
/**
   ...
   *
   * @license MIT
   */function s(){return s=Object.assign?Object.assign.bind():function(e){for(var n=1;n<arguments.length;n++){var t=arguments[n];for(var o in t)Object.prototype.hasOwnProperty.call(t,o)&&(e[o]=t[o])}return e},s.apply(this,arguments)}
/**
   * virtual-core
   *
   * Copyright (c) TanStack
...
/**
   ...
   *
   * @license MIT
   */var O="undefined"!=typeof document?r.useLayoutEffect:r.useEffect;function x(e){var n=r.useReducer((function(){return{}}),{})[1],o=i({},e,{onChange:function(o,r){r?t.flushSync(n):n(),null==e.onChange||e.onChange(o,r)}}),s=r.useState((function(){return new y(o)}))[0];return s.setOptions(o),r.useEffect((function(){return s._didMount()}),[]),O((function(){return s._willUpdate()})),s}e.Virtualizer=y,e.approxEqual=u,e.defaultKeyExtractor=c,e.defaultRangeExtractor=f,e.elementScroll=b,e.measureElement=v,e.memo=l,e.notUndefined=a,e.observeElementOffset=m,e.observeElementRect=d,e.observeWindowOffset=g,e.observeWindowRect=h,e.useVirtualizer=function(e){return x(i({observeElementRect:d,observeElementOffset:m,scrollToFn:b},e))},e.useWindowVirtualizer=function(e){return x(i({getScrollElement:function(){return"undefined"!=typeof document?window:null},observeElementRect:h,observeElementOffset:g,scrollToFn:p,initialOffset:"undefined"!=typeof document?window.scrollY:void 0},e))},e.windowScroll=p,Object.defineProperty(e,"__esModule",{value:!0})}));
