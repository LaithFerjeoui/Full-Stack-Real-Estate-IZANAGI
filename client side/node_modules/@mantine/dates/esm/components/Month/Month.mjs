...
const Month = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Box, { component: "table", ...getStyles("month"), size, ref, ...others }, !hideWeekdays && /* @__PURE__ */ React.createElement("thead", { ...getStyles("monthThead") }, /* @__PURE__ */ React.createElement(
    WeekdaysRow,
    {
      __staticSelector: __staticSelector || "Month",
      locale,
